...
const textArray = ["Developer", "Facilitator"];
...
const selectedTheme = localStorage.getItem('selecter-theme')
const selectedIcon = localStorage.getItem('selecter-icon')
...
themeButton.addEventListener('click', () =>{
    ...
    // e save the theme and the current icon that the use chose
